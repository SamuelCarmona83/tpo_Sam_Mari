        ...
        <article className="wid_5">
           ...
           <p> Es la solución definitiva para llevar un control preciso de los gastos en grupo. Ya sea que estés planeando un viaje, 
            ...
            <p>
                ...
                facilisis aliquet ante nullam posuere, condimentum laoreet egestas tristique dapibus magnis rhoncus
                tortor. Aliquam laoreet eleifend tellus quis diam dignissim suspendisse feugiat aliquet eros, etiam
                consequat dictum primis euismod risus viverra vehicula accumsan. Eleifend turpis aliquet tempor
                taciti in libero id sociosqu sociis erat auctor montes, eget netus arcu penatibus bibendum odio
                per inceptos mattis mollis vulputate, viverra diam senectus volutpat purus ultrices proin neque 
                etiam nisi aptent.
            </p>
        </article>
